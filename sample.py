...
def main(args, rank, master_port):
    ...
    if "gemma3" in args.text_encoder:
        ...
        for res in resolution:
            for idx, item in tqdm(enumerate(data)):
                ...
                model_kwargs = dict(
                    ...
                    cfg_trunc=1 - args.cfg_trunc if hasattr(args, 'cfg_trunc') else 1.0,
                    renorm_cfg=args.renorm_cfg if hasattr(args, 'renorm_cfg') else True,
                )
                ...
                if args.solver == "dpm":
                    ...
                    samples = sample_fn(z, steps=args.num_sampling_steps, order=2, skip_type="time_uniform_flow", method="multistep", flow_shift=args.t_shift)
                else:
                    transport = create_transport(
                        args.path_type,
                        args.prediction,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ema", action="store_true", help="Use EMA models.", default=False)
